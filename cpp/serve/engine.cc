...
class EngineImpl : public Engine {
 ...
 public:
  ...
  static Result<EngineCreationOutput> Create(const std::string& engine_config_json_str,
    ...
    n->grammar_compiler_.emplace(xgrammar::TokenizerInfo(n->token_table_));
 ...
 private:
  ...
  // Cached grammar compiler for grammar matching. It is initialized after the tokenizer is loaded.
  std::optional<xgrammar::GrammarCompiler> grammar_compiler_;
  // Models
  Array<Model> models_;
