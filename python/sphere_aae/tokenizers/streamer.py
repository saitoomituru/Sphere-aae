"""Streamers in Astro Agent Edge (AAE)."""
...
@tvm_ffi.register_object("sphere_aae.TextStreamer")  # pylint: disable=protected-access
...
@tvm_ffi.register_object("sphere_aae.StopStrHandler")  # pylint: disable=protected-access
class StopStrHandler(Object):
    """The stop string handler in Astro Agent Edge (AAE), which takes input delta tokens
