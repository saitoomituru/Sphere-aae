"""The tokenizer and related tools in Astro Agent Edge (AAE).
This tokenizer essentially wraps and binds the HuggingFace tokenizer
library and sentencepiece.
Reference: https://github.com/sphere-aae/tokenizers-cpp
"""
...
@tvm_ffi.register_object("sphere_aae.Tokenizer")  # pylint: disable=protected-access
class Tokenizer(Object):
    """The tokenizer class in Astro Agent Edge (AAE)."""
