"""Astro Agent Edge (AAE) server metrics entrypoints"""

import fastapi
from fastapi.responses import PlainTextResponse

from sphere_aae.serve.server import ServerContext
...
async def metrics(_request: fastapi.Request):
    ...
    # TODO(sphere-aae-team): consider refactor server context to
    # single engine since multiple AsyncSphereAaeEngine do not work well with each other
