"""Configuration dataclasses used in Astro Agent Edge (AAE) serving"""
...
class EngineConfig:  # pylint: disable=too-many-instance-attributes
    """The class of SphereAaeEngine execution configuration.
    ...
    opt : Optional[str]
        ...
        Astro Agent Edge (AAE) maintains a predefined set of optimization flags,
