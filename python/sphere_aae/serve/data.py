"""Classes denoting multi-modality data used in Astro Agent Edge (AAE) serving"""
...
@tvm_ffi.register_object("sphere_aae.serve.Data")  # pylint: disable=protected-access
...
@tvm_ffi.register_object("sphere_aae.serve.TextData")  # pylint: disable=protected-access
class TextData(Data):
...
@tvm_ffi.register_object("sphere_aae.serve.TokenData")  # type: ignore  # pylint: disable=protected-access
...
@tvm_ffi.register_object("sphere_aae.serve.ImageData")  # type: ignore  # pylint: disable=protected-access
...
@tvm_ffi.register_object("sphere_aae.serve.RequestStreamOutput")  # pylint: disable=protected-access
