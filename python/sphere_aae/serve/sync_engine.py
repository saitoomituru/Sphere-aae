"""The Astro Agent Edge (AAE) synchronized engine.
...
from sphere_aae.serve.engine_base import (
    EngineMetrics,
...
from sphere_aae.serve.request import Request
...
class SyncSphereAaeEngine:
    """The Python interface of synchronize request serving engine for Astro Agent Edge (AAE).
    ...
    def __init__(  # pylint: disable=too-many-arguments,too-many-locals
        ...
        *,
        ...
        self._ffi = _create_tvm_module(
            "sphere_aae.serve.create_engine",
            ffi_funcs=[
                "init",
                "add_request",
                "abort_request",
