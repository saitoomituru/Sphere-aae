...
from ..engine import AsyncSphereAaeEngine
...
class ServerContext:
    ...
    def __init__(self) -> None:
        self._models: Dict[str, AsyncSphereAaeEngine] = {}
    ...
    def add_model(self, hosted_model: str, engine: AsyncSphereAaeEngine) -> None:
    ...
    def get_engine(self, model: Optional[str]) -> Optional[AsyncSphereAaeEngine]:
