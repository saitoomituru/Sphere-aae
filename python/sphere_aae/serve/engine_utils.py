...
from sphere_aae.protocol import error_protocol, openai_api_protocol
...
def get_generation_config(
    ...
    """Create the generation config in Astro Agent Edge (AAE) out from the input request protocol."""
    kwargs: Dict[str, Any]
    if isinstance(
        request, (openai_api_protocol.CompletionRequest, openai_api_protocol.ChatCompletionRequest)
    ):
