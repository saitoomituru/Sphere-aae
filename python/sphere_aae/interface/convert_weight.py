...
from sphere_aae.loader import LOADER
...
from sphere_aae.support.preshard import apply_preshard
from sphere_aae.support.style import bold, green
...
class ConversionArgs:  # pylint: disable=too-many-instance-attributes
    """Arguments to Astro Agent Edge (AAE)'s weight conversation and quantization flow."""
...
def _convert_args(args: ConversionArgs) -> None:  # pylint: disable=too-many-locals
    pre_shards_num = os.getenv("SPHERE_AAE_INTERNAL_PRESHARD_NUM")
...
def convert_weight(  # pylint: disable=too-many-arguments
    ...
    """Astro Agent Edge (AAE)'s weight conversation and quantization flow."""
