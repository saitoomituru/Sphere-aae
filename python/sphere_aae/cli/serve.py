...
from sphere_aae.interface.serve import serve
...
def main(argv):
    """Parse command line arguments and call `sphere_aae.interface.serve`."""
    parser = ArgumentParser("Astro Agent Edge (AAE) Serve CLI")
