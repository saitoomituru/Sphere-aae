...
from sphere_aae.interface.gen_config import CONV_TEMPLATES, gen_config
...
from sphere_aae.support.auto_config import detect_config, detect_model_type


def main(argv):
    """Parse command line argumennts and call `sphere_aae.compiler.gen_config`."""
    parser = ArgumentParser("Astro Agent Edge (AAE) Configuration Generator")
    ...
    parser.add_argument(
        ...
        type=_parse_output,
        required=True,
        help=HELP["output_gen_sphere_aae_chat_config"] + " (required)",
    )
