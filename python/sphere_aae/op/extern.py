...
link into the generated artifact of Astro Agent Edge (AAE). TVM PR #16247
...
To conveniently use those externel modules, Astro Agent Edge (AAE) compilation pipeline manages an extra global
