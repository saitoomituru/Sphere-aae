...
from sphere_aae.interface.compiler_flags import IPCAllReduceStrategyType
...
@register_pipeline("sphere_aae")
def _sphere_aae_pipeline(  # pylint: disable=too-many-arguments
