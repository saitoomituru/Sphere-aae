...
def huggingface(model_config: Gemma3Config, quantization: Quantization) -> ExternMapping:
    ...
    sphere_aae_prefix = "language_model."
    ...
    for i in range(model_config.text_config.num_hidden_layers):
        ...
        sphere_aae_name = f"{sphere_aae_prefix + mlp}.gate_up_proj.weight"
        ...
        sphere_aae_name = f"model.layers.{i}.input_layernorm.weight"
        sphere_aae_param = named_parameters[sphere_aae_prefix + sphere_aae_name]
        mapping.add_mapping(
            sphere_aae_prefix + sphere_aae_name,
            [hf_prefix + sphere_aae_name],
            functools.partial(
                lambda x, dtype: (x + 1).astype(dtype),
                dtype=named_parameters[sphere_aae_prefix + sphere_aae_name].dtype,
            ),
        )

        sphere_aae_name = f"model.layers.{i}.post_attention_layernorm.weight"
        sphere_aae_param = named_parameters[sphere_aae_prefix + sphere_aae_name]
        mapping.add_mapping(
            sphere_aae_prefix + sphere_aae_name,
            [hf_prefix + sphere_aae_name],
        ...
        sphere_aae_name = f"model.layers.{i}.pre_feedforward_layernorm.weight"
        sphere_aae_param = named_parameters[sphere_aae_prefix + sphere_aae_name]
        mapping.add_mapping(
            sphere_aae_prefix + sphere_aae_name,
            [hf_prefix + sphere_aae_name],
        ...
        sphere_aae_name = f"model.layers.{i}.post_feedforward_layernorm.weight"
        sphere_aae_param = named_parameters[sphere_aae_prefix + sphere_aae_name]
        mapping.add_mapping(
            sphere_aae_prefix + sphere_aae_name,
            [hf_prefix + sphere_aae_name],
        ...
        sphere_aae_name = f"model.layers.{i}.self_attn.k_norm.weight"
        sphere_aae_param = named_parameters[sphere_aae_prefix + sphere_aae_name]
        mapping.add_mapping(
            sphere_aae_prefix + sphere_aae_name,
            [hf_prefix + sphere_aae_name],
        ...
        sphere_aae_name = f"model.layers.{i}.self_attn.q_norm.weight"
        sphere_aae_param = named_parameters[sphere_aae_prefix + sphere_aae_name]
        mapping.add_mapping(
            sphere_aae_prefix + sphere_aae_name,
            [hf_prefix + sphere_aae_name],
    ...
    sphere_aae_name = "model.norm.weight"
    sphere_aae_param = named_parameters[sphere_aae_prefix + sphere_aae_name]
    mapping.add_mapping(
        sphere_aae_prefix + sphere_aae_name,
        [hf_prefix + sphere_aae_name],
    ...
    for sphere_aae_name, sphere_aae_param in named_parameters.items():
        if sphere_aae_name not in mapping.param_map:
            mapping.add_mapping(
                sphere_aae_name,
                [hf_prefix + sphere_aae_name[len(sphere_aae_prefix) :]],
                functools.partial(
