"""Astro Agent Edge (AAE) bench backends"""
...
from sphere_aae.bench.request_record import Metrics, RequestRecord, ServerMetrics
...
class OpenAIChatEndPoint(APIEndPoint):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        if os.getenv("SPHERE_AAE_API_KEY"):
            self.headers["Authorization"] = f"Bearer {os.getenv('SPHERE_AAE_API_KEY')}"
...
def create_api_endpoint(args: argparse.Namespace) -> APIEndPoint:
    ...
    if args.api_endpoint in ["openai", "sphere_aae", "sglang"]:
