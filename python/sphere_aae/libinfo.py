...
SPHERE_AAE_LIBRARY_PATH = os.environ.get("SPHERE_AAE_LIBRARY_PATH", None)
...
def get_dll_directories():
    """Get extra Sphere-aae dll directories"""
    ...
    if SPHERE_AAE_LIBRARY_PATH:
        dll_path.append(SPHERE_AAE_LIBRARY_PATH)
