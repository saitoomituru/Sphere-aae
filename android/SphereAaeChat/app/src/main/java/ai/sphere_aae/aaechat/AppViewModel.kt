package ai.sphere_aae.aaechat

import ai.sphere_aae.aaellm.SphereAaeEngine
import ai.sphere_aae.aaellm.OpenAIProtocol
...
import ai.sphere_aae.aaellm.OpenAIProtocol.ChatCompletionMessage
import ai.sphere_aae.aaellm.OpenAIProtocol.ChatCompletionMessageContent
...
class AppViewModel(application: Application) : AndroidViewModel(application) {
    ...
    companion object {
        const val AppConfigFilename = "sphere-aae-app-config.json"
        const val ModelConfigFilename = "sphere-aae-chat-config.json"
    ...
    fun copyError() {
        ...
        clipboard.setPrimaryClip(ClipData.newPlainText("SphereAaeChat", errorMessage()))
    }
    ...
    inner class ChatState {
        ...
        private var modelChatState = mutableStateOf(ModelChatState.Ready)
            @Synchronized get
            @Synchronized set
        private val engine = SphereAaeEngine()
